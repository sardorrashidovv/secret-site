...
const QUIZ_QUESTIONS = [
    {
        ...
        options: ["Форсаж", "Матрица", "Интерстеллар", "Гарри Поттер"],
        correct: 0  // Индекс правильного ответа (0 = Форсаж)
    },
    {
        question: "Какое мое любимое блюдо?",
        options: ["Пицца", "Суши", "Паста", "Бургер"],
        correct: 3  // Индекс правильного ответа (3 = Бургер)
    },
    {
        question: "Когда мой день рождения?",
        options: ["Январь", "Февраль", "Июль", "Декабрь"],
        correct: 1  // Индекс правильного ответа (1 = Февраль)
    },
    {
        question: "Мой любимый цвет?",
        options: ["Красный", "Голубой", "Зелёный", "Жёлтый"],
        correct: 1  // Индекс правильного ответа (1 = Голубой)
    },
    {
        question: "Что я люблю делать в свободное время?",
        options: ["Спать", "Рисовать", "Гулять", "Танцевать"],
        correct: 2  // Индекс правильного ответа (2 = Гулять)
    }
];
...
function submitQuiz() {
    ...
    if (correctCount <= 1) {
        ...
        resultMessage = "Официально лу��ший человек для этой должности.";
    }
